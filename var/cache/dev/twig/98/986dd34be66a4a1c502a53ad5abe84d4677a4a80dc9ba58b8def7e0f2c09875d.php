...
class __TwigTemplate_6942e5bd660c74d6bb1161069603e1374d0fb3e5723ff2e05cc28a9aa051f475 extends \Twig\Template
{
    private $source;
...
<a";
    ...
    <span class=\"float-right\">
        ";
        // line 12
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "request", []), "get", [0 => "sort"], "method") == (isset($context["key"]) || array_key_exists("key", $context) ? $context["key"] : (function () { throw new RuntimeError('Variable "key" does not exist.', 12, $this->source); })()))) {
            // line 13
            echo "            ";
            if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "request", []), "get", [0 => "direction"], "method") == "desc")) {
                // line 14
...
", "@KnpPaginator/Pagination/font_awesome_sortable_link.html.twig", "C:\\wamp64\\www\\my-project\\vendor\\knplabs\\knp-paginator-bundle\\Resources\\views\\Pagination\\font_awesome_sortable_link.html.twig");
    }
}
