...
class __TwigTemplate_df46f9fa9449c8a504ab92e32a6ca9228e7ee0d7b1cbecfd92954eb194b7ef38 extends \Twig\Template
{
    private $source;
...
";
    ...
    {
        return new Source("<form method=\"post\"  style=\"display: inherit;\" action=\"{{ path('cours_delete', {'id': cour.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ cour.id) }}\">
    <button class=\"badge badge-danger\">Delete</button>
</form>
", "cours/_delete_form.html.twig", "C:\\wamp64\\www\\my-project\\templates\\cours\\_delete_form.html.twig");
    }
}
