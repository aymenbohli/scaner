...
// Returns the private 'App\Repository\CategoryCoursRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CategoryCoursRepository.php';

return $this->privates['App\\Repository\\CategoryCoursRepository'] = new \App\Repository\CategoryCoursRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
