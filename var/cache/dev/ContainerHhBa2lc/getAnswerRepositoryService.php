...
// Returns the private 'App\Repository\AnswerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AnswerRepository.php';

return $this->privates['App\\Repository\\AnswerRepository'] = new \App\Repository\AnswerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
