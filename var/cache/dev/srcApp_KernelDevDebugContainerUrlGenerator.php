...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'category_cours_index' => [[], ['_controller' => 'App\\Controller\\CategoryCoursController::index'], [], [['text', '/categoy-cours/']], [], []],
        'category_cours_new' => [[], ['_controller' => 'App\\Controller\\CategoryCoursController::new'], [], [['text', '/categoy-cours/new']], [], []],
        'category_cours_show' => [['id'], ['_controller' => 'App\\Controller\\CategoryCoursController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/categoy-cours']], [], []],
        'category_cours_edit' => [['id'], ['_controller' => 'App\\Controller\\CategoryCoursController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/categoy-cours']], [], []],
        'category_cours_delete' => [['id'], ['_controller' => 'App\\Controller\\CategoryCoursController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/categoy-cours']], [], []],
