...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'classes_index' => [[], ['_controller' => 'App\\Controller\\ClassesController::index'], [], [['text', '/classes/']], [], []],
        'classes_new' => [[], ['_controller' => 'App\\Controller\\ClassesController::new'], [], [['text', '/classes/new']], [], []],
        'classes_show' => [['id'], ['_controller' => 'App\\Controller\\ClassesController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/classes']], [], []],
        'classes_edit' => [['id'], ['_controller' => 'App\\Controller\\ClassesController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/classes']], [], []],
        'classes_delete' => [['id'], ['_controller' => 'App\\Controller\\ClassesController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/classes']], [], []],
        ...
        'etudiant_index' => [[], ['_controller' => 'App\\Controller\\EtudiantController::index'], [], [['text', '/etudiant/']], [], []],
        'etudiant_new' => [[], ['_controller' => 'App\\Controller\\EtudiantController::new'], [], [['text', '/etudiant/new']], [], []],
        'etudiant_show' => [['id'], ['_controller' => 'App\\Controller\\EtudiantController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/etudiant']], [], []],
        'etudiant_edit' => [['id'], ['_controller' => 'App\\Controller\\EtudiantController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/etudiant']], [], []],
        'etudiant_delete' => [['id'], ['_controller' => 'App\\Controller\\EtudiantController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/etudiant']], [], []],
