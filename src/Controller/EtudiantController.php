...
class EtudiantController extends AbstractController
{
     ...
     */
    public function index(EtudiantRepository $etudiantRepository,Request $request,PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $etudiantRepository->findAll(), /* query NOT result */
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash('success', 'Edudiant créé!');
    ...
    public function edit(Request $request, Etudiant $etudiant): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Edudiant Modifier!');
    ...
    public function delete(Request $request, Etudiant $etudiant): Response
    {
        if ($this->isCsrfTokenValid('delete'.$etudiant->getId(), $request->request->get('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('success', 'Edudiant Supprimer!');
        }
